      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Text("Managemen", style: TextStyle(color: Color(0xff161E5F),fontSize: 25, fontWeight: FontWeight.bold),),
          ),
          Container(
            margin: EdgeInsets.only(left: 10, top: 20),
            alignment: Alignment.centerLeft,
            child: Row(
              children: [
                Icon(Icons.people_alt_rounded, size: 45,color: Color(0xff161E5F),),
                SizedBox(
                  width: 15,
                ),
                Container(
                  child: Text("Managemen Petugas", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xff161E5F)),),
                ),
                SizedBox(
                  width: 130,
                ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.people_outline_rounded, size: 45,color: Color(0xff161E5F),),
                SizedBox(
                  width: 15,
                ),
                Container(
                  child: Text("Managemen User", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xff161E5F)),),
                ),
                SizedBox(
                  width: 163,
                ),
